...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Lucide-1.31.0-orange.svg" alt="Lucide Icons Version">
...
- **Type-safe API**: 1,738+1768 enum cases with full Xcode autocomplete — compile-time verification prevents runtime icon-not-found errors
...
- 1768 enum cases (e.g., `.house`, `.settings`, `.heart`)
...
### [🔍 Browse all 1768 icons on lucide.dev/icons →](https://lucide.dev/icons)
