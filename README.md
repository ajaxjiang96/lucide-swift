...
- **Type-safe API**: 1738 enum cases with full Xcode autocomplete
...
- 1738 enum cases (e.g., `.house`, `.settings`, `.heart`)
...
- **Better tooling**: Xcode autocomplete shows all 1738 available icons
...
### [🔍 Browse all 1738 icons on lucide.dev/icons →](https://lucide.dev/icons)
