...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Lucide-1.43.0-orange.svg" alt="Lucide Icons Version">
...
- **Type-safe API**: 1819 enum cases with full Xcode autocomplete — compile-time verification prevents runtime icon-not-found errors
...
```swift
dependencies: [
    .package(url: "https://github.com/ajaxjiang96/lucide-swift.git", from: "0.9.2")
]
```
...
- 1819 enum cases (e.g., `.house`, `.settings`, `.heart`)
...
### [🔍 Browse all 1819 icons on lucide.dev/icons →](https://lucide.dev/icons)
...
- **SPM dependency:** `.package(url: "https://github.com/ajaxjiang96/lucide-swift.git", from: "0.9.2")`
