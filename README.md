...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Lucide-1.40.0-orange.svg" alt="Lucide Icons Version">
...
- **Type-safe API**: 1,738+1800 enum cases with full Xcode autocomplete — compile-time verification prevents runtime icon-not-found errors
...
- 1800 enum cases (e.g., `.house`, `.settings`, `.heart`)
...
### [🔍 Browse all 1800 icons on lucide.dev/icons →](https://lucide.dev/icons)
