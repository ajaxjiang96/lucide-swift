...
- **Type-safe API**: 1,738+1757 enum cases with full Xcode autocomplete — compile-time verification prevents runtime icon-not-found errors
...
- 1757 enum cases (e.g., `.house`, `.settings`, `.heart`)
...
### [🔍 Browse all 1757 icons on lucide.dev/icons →](https://lucide.dev/icons)
