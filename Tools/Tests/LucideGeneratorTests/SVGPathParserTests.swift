...
final class SVGPathParserTests: XCTestCase {
    ...
    func testRelativeArcAfterCloseUsesSubpathStart() {
        let path = "M21 15V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h10v-5a1 1 0 011-1za2.4 2.4 0 01-.706 1.706l-3.588 3.588A2.4 2.4 0 0115 21"
        let source = SwiftCodeGenerator.generateIconFile(
            icon: Icon(name: "calendar-fold", pathStrings: [path], type: .regular)
        )
        XCTAssertTrue(source.contains("20.294") && source.contains("16.706"))
    }
}
