...
internal enum LucideIcon_CircleQuestionMark {
    
/// Circle Question Mark icon path (combined)
...
/// Circle Question Mark icon open subpaths
...
/// Circle Question Mark icon closed subpaths
