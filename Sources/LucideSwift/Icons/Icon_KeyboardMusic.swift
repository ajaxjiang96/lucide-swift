...
/// Keyboard Music icon
internal enum LucideIcon_KeyboardMusic {
    
/// Keyboard Music icon path (combined)
...
/// Keyboard Music icon open subpaths
...
/// Keyboard Music icon closed subpaths
