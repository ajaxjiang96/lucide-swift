//
//  Icon_SquareDashedBottomCode.swift
//  LucideSwift
//
...
internal enum LucideIcon_SquareDashedBottomCode {
    
/// Square Dashed Bottom Code icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 10.0, y: 9.5))
path.addLine(to: CGPoint(x: 8.0, y: 12.0))
path.addLine(to: CGPoint(x: 10.0, y: 14.5))
path.move(to: CGPoint(x: 14.0, y: 21.0))
path.addLine(to: CGPoint(x: 15.0, y: 21.0))
path.move(to: CGPoint(x: 14.0, y: 9.5))
path.addLine(to: CGPoint(x: 16.0, y: 12.0))
path.addLine(to: CGPoint(x: 14.0, y: 14.5))
...
/// Square Dashed Bottom Code icon open subpaths
...
/// Square Dashed Bottom Code icon closed subpaths
