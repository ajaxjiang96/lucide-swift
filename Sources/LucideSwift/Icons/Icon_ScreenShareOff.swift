...
internal enum LucideIcon_ScreenShareOff {
    
/// Screen Share Off icon path (combined)
...
/// Screen Share Off icon open subpaths
...
/// Screen Share Off icon closed subpaths
