...
internal enum LucideIcon_PanelBottomOpen {
    
/// Panel Bottom Open icon path (combined)
...
/// Panel Bottom Open icon open subpaths
...
/// Panel Bottom Open icon closed subpaths
