...
/// Folder Check icon
internal enum LucideIcon_FolderCheck {
    
/// Folder Check icon path (combined)
...
/// Folder Check icon open subpaths
...
/// Folder Check icon closed subpaths
