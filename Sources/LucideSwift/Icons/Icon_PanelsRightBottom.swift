...
internal enum LucideIcon_PanelsRightBottom {
    
/// Panels Right Bottom icon path (combined)
...
/// Panels Right Bottom icon open subpaths
...
/// Panels Right Bottom icon closed subpaths
