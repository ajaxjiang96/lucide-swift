...
/// Sticky Note X icon
internal enum LucideIcon_StickyNoteX {
    
/// Sticky Note X icon path (combined)
...
/// Sticky Note X icon open subpaths
...
/// Sticky Note X icon closed subpaths
