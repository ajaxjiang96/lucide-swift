...
internal enum LucideIcon_SquareDashedBottom {
    
/// Square Dashed Bottom icon path (combined)
...
/// Square Dashed Bottom icon open subpaths
...
/// Square Dashed Bottom icon closed subpaths
