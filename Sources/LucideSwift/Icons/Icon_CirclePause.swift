...
/// Circle Pause icon
internal enum LucideIcon_CirclePause {
    
/// Circle Pause icon path (combined)
...
/// Circle Pause icon open subpaths
...
/// Circle Pause icon closed subpaths
