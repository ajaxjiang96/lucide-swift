...
internal enum LucideIcon_HardDriveDownload {
    
/// Hard Drive Download icon path (combined)
...
/// Hard Drive Download icon open subpaths
...
/// Hard Drive Download icon closed subpaths
