...
internal enum LucideIcon_PanelRightDashed {
    
/// Panel Right Dashed icon path (combined)
...
/// Panel Right Dashed icon open subpaths
...
/// Panel Right Dashed icon closed subpaths
