...
/// Circle Check icon
internal enum LucideIcon_CircleCheck {
    
/// Circle Check icon path (combined)
...
/// Circle Check icon open subpaths
...
/// Circle Check icon closed subpaths
