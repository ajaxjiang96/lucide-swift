...
/// Circle Slash 2 icon
internal enum LucideIcon_CircleSlash2 {
    
/// Circle Slash 2 icon path (combined)
...
/// Circle Slash 2 icon open subpaths
...
/// Circle Slash 2 icon closed subpaths
