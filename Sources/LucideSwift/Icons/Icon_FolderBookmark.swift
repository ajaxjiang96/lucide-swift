...
internal enum LucideIcon_FolderBookmark {
    
/// Folder Bookmark icon path (combined)
...
/// Folder Bookmark icon open subpaths
...
/// Folder Bookmark icon closed subpaths
