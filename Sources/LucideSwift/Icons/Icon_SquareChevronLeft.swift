...
internal enum LucideIcon_SquareChevronLeft {
    
/// Square Chevron Left icon path (combined)
...
/// Square Chevron Left icon open subpaths
...
/// Square Chevron Left icon closed subpaths
