...
internal enum LucideIcon_ChartBarIncreasing {
    
/// Chart Bar Increasing icon path (combined)
...
/// Chart Bar Increasing icon open subpaths
...
/// Chart Bar Increasing icon closed subpaths
