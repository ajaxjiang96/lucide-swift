//
//  Icon_SquareArrowDownRight.swift
//  LucideSwift
//
...
internal enum LucideIcon_SquareArrowDownRight {
    
/// Square Arrow Down Right icon path (combined)
...
/// Square Arrow Down Right icon open subpaths
...
/// Square Arrow Down Right icon closed subpaths
