...
internal enum LucideIcon_SquareActivity {
    
/// Square Activity icon path (combined)
...
/// Square Activity icon open subpaths
...
/// Square Activity icon closed subpaths
