...
/// Midi Port icon
internal enum LucideIcon_MidiPort {
    
/// Midi Port icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 12.0, y: 18.0))
path.addLine(to: CGPoint(x: 12.01, y: 18.0))
path.move(to: CGPoint(x: 15.0, y: 2.458))
path.addLine(to: CGPoint(x: 15.0, y: 5.0))
path.addCurve(to: CGPoint(x: 14.0, y: 6.0), control1: CGPoint(x: 15.0, y: 5.552284749830793), control2: CGPoint(x: 14.552284749830793, y: 6.0))
path.addLine(to: CGPoint(x: 10.0, y: 6.0))
path.addCurve(to: CGPoint(x: 9.0, y: 5.0), control1: CGPoint(x: 9.447715250169207, y: 6.0), control2: CGPoint(x: 9.0, y: 5.552284749830793))
path.addLine(to: CGPoint(x: 9.0, y: 2.458))
...
/// Midi Port icon closed subpaths
