...
internal enum LucideIcon_TableCellsMerge {
    
/// Table Cells Merge icon path (combined)
...
/// Table Cells Merge icon open subpaths
...
/// Table Cells Merge icon closed subpaths
