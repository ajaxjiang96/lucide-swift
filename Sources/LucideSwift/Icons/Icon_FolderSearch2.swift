...
internal enum LucideIcon_FolderSearch2 {
    
/// Folder Search 2 icon path (combined)
...
path.closeSubpath()
path.move(to: CGPoint(x: 13.3, y: 14.3))
path.addLine(to: CGPoint(x: 15.0, y: 16.0))
path.move(to: CGPoint(x: 9.0, y: 12.5))
path.addCurve(to: CGPoint(x: 11.5, y: 15.0), control1: CGPoint(x: 9.0, y: 13.880711874576985), control2: CGPoint(x: 10.119288125423017, y: 15.0))
path.addCurve(to: CGPoint(x: 14.0, y: 12.5), control1: CGPoint(x: 12.880711874576985, y: 15.0), control2: CGPoint(x: 14.0, y: 13.880711874576983))
path.addCurve(to: CGPoint(x: 11.5, y: 10.0), control1: CGPoint(x: 14.0, y: 11.119288125423017), control2: CGPoint(x: 12.880711874576985, y: 10.0))
path.addCurve(to: CGPoint(x: 9.0, y: 12.5), control1: CGPoint(x: 10.119288125423017, y: 10.0), control2: CGPoint(x: 9.0, y: 11.119288125423015))
    return path
}()
/// Folder Search 2 icon open subpaths
...
/// Folder Search 2 icon closed subpaths
