...
internal enum LucideIcon_StickyNoteOff {
    
/// Sticky Note Off icon path (combined)
...
/// Sticky Note Off icon open subpaths
...
/// Sticky Note Off icon closed subpaths
