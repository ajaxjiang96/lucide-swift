...
internal enum LucideIcon_CircleChevronRight {
    
/// Circle Chevron Right icon path (combined)
...
/// Circle Chevron Right icon open subpaths
...
/// Circle Chevron Right icon closed subpaths
