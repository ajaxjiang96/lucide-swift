...
internal enum LucideIcon_CircleArrowLeft {
    
/// Circle Arrow Left icon path (combined)
...
/// Circle Arrow Left icon open subpaths
...
/// Circle Arrow Left icon closed subpaths
