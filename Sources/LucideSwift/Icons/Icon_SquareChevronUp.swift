...
internal enum LucideIcon_SquareChevronUp {
    
/// Square Chevron Up icon path (combined)
...
/// Square Chevron Up icon open subpaths
...
/// Square Chevron Up icon closed subpaths
