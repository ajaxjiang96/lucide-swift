...
/// Folder Minus icon
internal enum LucideIcon_FolderMinus {
    
/// Folder Minus icon path (combined)
...
/// Folder Minus icon open subpaths
...
/// Folder Minus icon closed subpaths
