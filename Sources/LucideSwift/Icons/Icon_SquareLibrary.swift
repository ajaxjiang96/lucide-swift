...
/// Square Library icon
internal enum LucideIcon_SquareLibrary {
    
/// Square Library icon path (combined)
...
/// Square Library icon open subpaths
...
/// Square Library icon closed subpaths
