...
internal enum LucideIcon_SquareChevronDown {
    
/// Square Chevron Down icon path (combined)
...
/// Square Chevron Down icon open subpaths
...
/// Square Chevron Down icon closed subpaths
