...
internal enum LucideIcon_CircleEllipsis {
    
/// Circle Ellipsis icon path (combined)
...
/// Circle Ellipsis icon open subpaths
...
/// Circle Ellipsis icon closed subpaths
