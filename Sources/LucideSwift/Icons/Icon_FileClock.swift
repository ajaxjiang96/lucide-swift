...
/// File Clock icon
internal enum LucideIcon_FileClock {
    
/// File Clock icon path (combined)
...
path.addLine(to: CGPoint(x: 4.0, y: 6.85))
...
path.addLine(to: CGPoint(x: 8.0, y: 16.2))
path.addLine(to: CGPoint(x: 9.6, y: 17.2))
path.move(to: CGPoint(x: 2.0, y: 16.0))
path.addCurve(to: CGPoint(x: 8.0, y: 22.0), control1: CGPoint(x: 2.000000000000001, y: 19.31370849898476), control2: CGPoint(x: 4.68629150101524, y: 22.0))
path.addCurve(to: CGPoint(x: 14.0, y: 16.0), control1: CGPoint(x: 11.313708498984761, y: 22.0), control2: CGPoint(x: 14.0, y: 19.31370849898476))
path.addCurve(to: CGPoint(x: 8.0, y: 10.0), control1: CGPoint(x: 14.0, y: 12.686291501015239), control2: CGPoint(x: 11.313708498984761, y: 10.0))
path.addCurve(to: CGPoint(x: 2.0, y: 16.0), control1: CGPoint(x: 4.68629150101524, y: 10.0), control2: CGPoint(x: 2.000000000000001, y: 12.686291501015239))
    return path
}()
/// File Clock icon open subpaths
...
/// File Clock icon closed subpaths
