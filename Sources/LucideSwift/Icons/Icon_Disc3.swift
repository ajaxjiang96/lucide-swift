...
/// Disc 3 icon
internal enum LucideIcon_Disc3 {
    
/// Disc 3 icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 6.0, y: 12.0))
path.addCurve(to: CGPoint(x: 7.8, y: 7.8), control1: CGPoint(x: 6.0, y: 10.3), control2: CGPoint(x: 6.7, y: 8.8))
path.move(to: CGPoint(x: 18.0, y: 12.0))
path.addCurve(to: CGPoint(x: 16.2, y: 16.2), control1: CGPoint(x: 18.0, y: 13.7), control2: CGPoint(x: 17.3, y: 15.2))
