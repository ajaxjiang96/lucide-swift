...
internal enum LucideIcon_PanelTopDashed {
    
/// Panel Top Dashed icon path (combined)
...
/// Panel Top Dashed icon open subpaths
...
/// Panel Top Dashed icon closed subpaths
