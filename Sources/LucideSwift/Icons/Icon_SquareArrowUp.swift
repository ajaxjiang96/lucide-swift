...
internal enum LucideIcon_SquareArrowUp {
    
/// Square Arrow Up icon path (combined)
...
/// Square Arrow Up icon open subpaths
...
/// Square Arrow Up icon closed subpaths
