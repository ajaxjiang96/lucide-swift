...
internal enum LucideIcon_CircleArrowDown {
    
/// Circle Arrow Down icon path (combined)
...
/// Circle Arrow Down icon open subpaths
...
/// Circle Arrow Down icon closed subpaths
