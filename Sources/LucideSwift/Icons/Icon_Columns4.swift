...
/// Columns 4 icon
internal enum LucideIcon_Columns4 {
    
/// Columns 4 icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 7.5, y: 3.0))
path.addLine(to: CGPoint(x: 7.5, y: 21.0))
path.move(to: CGPoint(x: 12.0, y: 3.0))
path.addLine(to: CGPoint(x: 12.0, y: 21.0))
path.move(to: CGPoint(x: 16.5, y: 3.0))
path.addLine(to: CGPoint(x: 16.5, y: 21.0))
...
/// Columns 4 icon closed subpaths
