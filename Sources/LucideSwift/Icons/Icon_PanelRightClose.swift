...
internal enum LucideIcon_PanelRightClose {
    
/// Panel Right Close icon path (combined)
...
/// Panel Right Close icon open subpaths
...
/// Panel Right Close icon closed subpaths
