...
/// File Music icon
internal enum LucideIcon_FileMusic {
    
/// File Music icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 11.65, y: 22.0))
...
path.addLine(to: CGPoint(x: 4.0, y: 14.35))
...
path.addLine(to: CGPoint(x: 11.0, y: 14.474))
...
path.addCurve(to: CGPoint(x: 8.0, y: 20.0), control1: CGPoint(x: 7.104569499661587, y: 22.0), control2: CGPoint(x: 8.0, y: 21.104569499661586))
path.addCurve(to: CGPoint(x: 6.0, y: 18.0), control1: CGPoint(x: 8.0, y: 18.895430500338414), control2: CGPoint(x: 7.104569499661587, y: 18.0))
path.addCurve(to: CGPoint(x: 4.0, y: 20.0), control1: CGPoint(x: 4.8954305003384135, y: 18.0), control2: CGPoint(x: 4.0, y: 18.895430500338414))
    return path
}()
/// File Music icon open subpaths
...
/// File Music icon closed subpaths
