//
//  Icon_Lab_JapaneseYenCircle.swift
//  LucideSwift
//
//  Auto-generated — DO NOT EDIT
//  Icon: japanese-yen-circle
//

import SwiftUI

/// Japanese Yen Circle icon
internal enum LucideLabIcon_Lab_JapaneseYenCircle {
    
/// Japanese Yen Circle icon path (combined)
...
/// Japanese Yen Circle icon open subpaths
...
/// Japanese Yen Circle icon closed subpaths
