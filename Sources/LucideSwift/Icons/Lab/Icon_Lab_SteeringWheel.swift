...
/// Steering Wheel icon
internal enum LucideLabIcon_Lab_SteeringWheel {
    
/// Steering Wheel icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 3.3, y: 7.0))
path.addLine(to: CGPoint(x: 10.3, y: 11.0))
path.move(to: CGPoint(x: 13.7, y: 11.0))
path.addLine(to: CGPoint(x: 20.7, y: 7.0))
...
/// Steering Wheel icon open subpaths
...
/// Steering Wheel icon closed subpaths
