...
/// Tennis Ball icon
internal enum LucideLabIcon_Lab_TennisBall {
    
/// Tennis Ball icon path (combined)
...
/// Tennis Ball icon open subpaths
...
/// Tennis Ball icon closed subpaths
