...
/// Gearbox Square icon
internal enum LucideLabIcon_Lab_GearboxSquare {
    
/// Gearbox Square icon path (combined)
...
/// Gearbox Square icon open subpaths
...
/// Gearbox Square icon closed subpaths
