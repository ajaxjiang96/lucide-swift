...
/// Type Square icon
internal enum LucideLabIcon_Lab_TypeSquare {
    
/// Type Square icon path (combined)
...
/// Type Square icon open subpaths
...
/// Type Square icon closed subpaths
