...
/// Heading Square icon
internal enum LucideLabIcon_Lab_HeadingSquare {
    
/// Heading Square icon path (combined)
...
/// Heading Square icon open subpaths
...
/// Heading Square icon closed subpaths
