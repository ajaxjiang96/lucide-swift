//
//  Icon_Lab_BaselineSquare.swift
//  LucideSwift
//
//  Auto-generated — DO NOT EDIT
//  Icon: baseline-square
//

import SwiftUI

/// Baseline Square icon
internal enum LucideLabIcon_Lab_BaselineSquare {
    
/// Baseline Square icon path (combined)
...
/// Baseline Square icon open subpaths
...
/// Baseline Square icon closed subpaths
