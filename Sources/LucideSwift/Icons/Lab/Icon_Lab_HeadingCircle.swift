...
/// Heading Circle icon
internal enum LucideLabIcon_Lab_HeadingCircle {
    
/// Heading Circle icon path (combined)
...
/// Heading Circle icon open subpaths
...
/// Heading Circle icon closed subpaths
