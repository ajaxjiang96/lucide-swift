...
/// Globe icon
internal enum LucideIcon_Globe {
    
/// Globe icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 12.0, y: 2.0))
path.addCurve(to: CGPoint(x: 11.999999999999998, y: 22.0), control1: CGPoint(x: 6.666666666666664, y: 7.600000000000003), control2: CGPoint(x: 6.666666666666668, y: 16.4))
path.addCurve(to: CGPoint(x: 12.000000000000002, y: 2.0), control1: CGPoint(x: 17.333333333333332, y: 16.4), control2: CGPoint(x: 17.333333333333332, y: 7.6000000000000005))
