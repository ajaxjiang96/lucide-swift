//
//  Icon_StickyNoteMinus.swift
//  LucideSwift
//
//  Auto-generated — DO NOT EDIT
//  Icon: sticky-note-minus
//

import SwiftUI

/// Sticky Note Minus icon
internal enum LucideIcon_StickyNoteMinus {
    
/// Sticky Note Minus icon path (combined)
...
/// Sticky Note Minus icon open subpaths
...
/// Sticky Note Minus icon closed subpaths
