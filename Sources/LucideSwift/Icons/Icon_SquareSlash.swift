...
/// Square Slash icon
internal enum LucideIcon_SquareSlash {
    
/// Square Slash icon path (combined)
...
/// Square Slash icon open subpaths
...
/// Square Slash icon closed subpaths
