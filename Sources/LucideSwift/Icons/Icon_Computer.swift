...
path.addCurve(to: CGPoint(x: 17.0, y: 10.0), control1: CGPoint(x: 19.0, y: 9.104569499661586), control2: CGPoint(x: 18.104569499661586, y: 10.0))
path.addLine(to: CGPoint(x: 7.0, y: 10.0))
path.addCurve(to: CGPoint(x: 5.0, y: 8.0), control1: CGPoint(x: 5.8954305003384135, y: 10.0), control2: CGPoint(x: 5.0, y: 9.104569499661586))
