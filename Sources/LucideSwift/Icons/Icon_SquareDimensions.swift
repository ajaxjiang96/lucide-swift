...
internal enum LucideIcon_SquareDimensions {
    
/// Square Dimensions icon path (combined)
...
/// Square Dimensions icon open subpaths
...
/// Square Dimensions icon closed subpaths
