...
internal enum LucideIcon_PanelLeftOpen {
    
/// Panel Left Open icon path (combined)
...
/// Panel Left Open icon open subpaths
...
/// Panel Left Open icon closed subpaths
