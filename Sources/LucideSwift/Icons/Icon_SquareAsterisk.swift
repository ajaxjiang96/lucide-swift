...
internal enum LucideIcon_SquareAsterisk {
    
/// Square Asterisk icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 12.0, y: 8.0))
path.addLine(to: CGPoint(x: 12.0, y: 16.0))
path.move(to: CGPoint(x: 8.5, y: 14.0))
path.addLine(to: CGPoint(x: 15.5, y: 10.0))
path.move(to: CGPoint(x: 8.5, y: 10.0))
path.addLine(to: CGPoint(x: 15.5, y: 14.0))
...
/// Square Asterisk icon open subpaths
...
/// Square Asterisk icon closed subpaths
