...
internal enum LucideIcon_SquareArrowUpRight {
    
/// Square Arrow Up Right icon path (combined)
...
/// Square Arrow Up Right icon open subpaths
...
/// Square Arrow Up Right icon closed subpaths
