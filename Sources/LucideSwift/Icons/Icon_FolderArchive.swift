...
/// Folder Archive icon
internal enum LucideIcon_FolderArchive {
    
/// Folder Archive icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 20.9, y: 19.8))
path.addCurve(to: CGPoint(x: 22.0, y: 17.999999999999996), control1: CGPoint(x: 21.579007594381533, y: 19.45786894679866), control2: CGPoint(x: 22.00529133616117, y: 18.760313732977433))
...
path.addLine(to: CGPoint(x: 9.1, y: 20.0))
...
path.addCurve(to: CGPoint(x: 15.0, y: 21.0), control1: CGPoint(x: 13.0, y: 20.104569499661586), control2: CGPoint(x: 13.895430500338414, y: 21.0))
...
/// Folder Archive icon open subpaths
...
/// Folder Archive icon closed subpaths
