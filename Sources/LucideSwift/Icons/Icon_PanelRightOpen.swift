...
internal enum LucideIcon_PanelRightOpen {
    
/// Panel Right Open icon path (combined)
...
/// Panel Right Open icon open subpaths
...
/// Panel Right Open icon closed subpaths
