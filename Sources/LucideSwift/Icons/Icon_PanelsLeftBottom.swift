...
internal enum LucideIcon_PanelsLeftBottom {
    
/// Panels Left Bottom icon path (combined)
...
/// Panels Left Bottom icon open subpaths
...
/// Panels Left Bottom icon closed subpaths
