...
/// Circle Small icon
internal enum LucideIcon_CircleSmall {
    
/// Circle Small icon path (combined)
...
/// Circle Small icon open subpaths
static let openPath: Path = {
    var path = Path()
            return path
}()
/// Circle Small icon closed subpaths
