...
internal enum LucideIcon_SquareArrowRight {
    
/// Square Arrow Right icon path (combined)
...
/// Square Arrow Right icon open subpaths
...
/// Square Arrow Right icon closed subpaths
