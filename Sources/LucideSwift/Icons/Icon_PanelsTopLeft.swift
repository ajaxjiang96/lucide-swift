...
internal enum LucideIcon_PanelsTopLeft {
    
/// Panels Top Left icon path (combined)
...
/// Panels Top Left icon open subpaths
...
/// Panels Top Left icon closed subpaths
