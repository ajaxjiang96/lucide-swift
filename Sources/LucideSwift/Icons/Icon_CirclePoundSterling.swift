//
//  Icon_CirclePoundSterling.swift
//  LucideSwift
//
...
internal enum LucideIcon_CirclePoundSterling {
    
/// Circle Pound Sterling icon path (combined)
...
/// Circle Pound Sterling icon open subpaths
...
/// Circle Pound Sterling icon closed subpaths
