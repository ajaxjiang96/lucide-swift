//
//  Icon_FaceSlightlyFrowning.swift
//  LucideSwift
//
...
internal enum LucideIcon_FaceSlightlyFrowning {
    
/// Face Slightly Frowning icon path (combined)
...
/// Face Slightly Frowning icon open subpaths
