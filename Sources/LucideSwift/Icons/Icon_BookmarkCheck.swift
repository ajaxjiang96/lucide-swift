...
/// Bookmark Check icon
internal enum LucideIcon_BookmarkCheck {
    
/// Bookmark Check icon path (combined)
...
/// Bookmark Check icon open subpaths
...
/// Bookmark Check icon closed subpaths
