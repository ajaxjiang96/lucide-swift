...
internal enum LucideIcon_StickyNoteCheck {
    
/// Sticky Note Check icon path (combined)
...
/// Sticky Note Check icon open subpaths
...
/// Sticky Note Check icon closed subpaths
