...
internal enum LucideIcon_CircleChevronUp {
    
/// Circle Chevron Up icon path (combined)
...
/// Circle Chevron Up icon open subpaths
...
/// Circle Chevron Up icon closed subpaths
