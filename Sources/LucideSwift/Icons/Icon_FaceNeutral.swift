...
/// Face Neutral icon
internal enum LucideIcon_FaceNeutral {
    
/// Face Neutral icon path (combined)
...
/// Face Neutral icon open subpaths
...
/// Face Neutral icon closed subpaths
