...
/// Square Percent icon
internal enum LucideIcon_SquarePercent {
    
/// Square Percent icon path (combined)
...
/// Square Percent icon open subpaths
...
/// Square Percent icon closed subpaths
