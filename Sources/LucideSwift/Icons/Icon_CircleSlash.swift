...
/// Circle Slash icon
internal enum LucideIcon_CircleSlash {
    
/// Circle Slash icon path (combined)
...
/// Circle Slash icon open subpaths
...
/// Circle Slash icon closed subpaths
