...
/// Sticky Notes icon
internal enum LucideIcon_StickyNotes {
    
/// Sticky Notes icon path (combined)
...
/// Sticky Notes icon open subpaths
...
/// Sticky Notes icon closed subpaths
