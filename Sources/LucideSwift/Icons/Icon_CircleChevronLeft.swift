...
internal enum LucideIcon_CircleChevronLeft {
    
/// Circle Chevron Left icon path (combined)
...
/// Circle Chevron Left icon open subpaths
...
/// Circle Chevron Left icon closed subpaths
