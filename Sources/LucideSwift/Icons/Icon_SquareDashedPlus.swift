...
internal enum LucideIcon_SquareDashedPlus {
    
/// Square Dashed Plus icon path (combined)
...
/// Square Dashed Plus icon open subpaths
...
/// Square Dashed Plus icon closed subpaths
