...
internal enum LucideIcon_TableProperties {
    
/// Table Properties icon path (combined)
...
/// Table Properties icon open subpaths
...
/// Table Properties icon closed subpaths
