...
internal enum LucideIcon_SquareArrowUpLeft {
    
/// Square Arrow Up Left icon path (combined)
...
/// Square Arrow Up Left icon open subpaths
...
/// Square Arrow Up Left icon closed subpaths
