...
internal enum LucideIcon_PanelBottomClose {
    
/// Panel Bottom Close icon path (combined)
...
/// Panel Bottom Close icon open subpaths
...
/// Panel Bottom Close icon closed subpaths
