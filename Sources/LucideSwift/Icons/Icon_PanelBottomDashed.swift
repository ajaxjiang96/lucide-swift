...
internal enum LucideIcon_PanelBottomDashed {
    
/// Panel Bottom Dashed icon path (combined)
...
/// Panel Bottom Dashed icon open subpaths
...
/// Panel Bottom Dashed icon closed subpaths
