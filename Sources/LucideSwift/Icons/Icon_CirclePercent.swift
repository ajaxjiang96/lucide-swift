...
/// Circle Percent icon
internal enum LucideIcon_CirclePercent {
    
/// Circle Percent icon path (combined)
...
/// Circle Percent icon open subpaths
...
/// Circle Percent icon closed subpaths
