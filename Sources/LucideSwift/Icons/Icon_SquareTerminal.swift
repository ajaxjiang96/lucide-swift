...
internal enum LucideIcon_SquareTerminal {
    
/// Square Terminal icon path (combined)
...
/// Square Terminal icon open subpaths
...
/// Square Terminal icon closed subpaths
