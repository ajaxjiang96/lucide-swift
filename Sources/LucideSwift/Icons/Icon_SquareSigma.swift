...
/// Square Sigma icon
internal enum LucideIcon_SquareSigma {
    
/// Square Sigma icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 16.0, y: 8.9))
...
path.addLine(to: CGPoint(x: 16.0, y: 15.1))
...
/// Square Sigma icon open subpaths
...
/// Square Sigma icon closed subpaths
