...
/// Square Pause icon
internal enum LucideIcon_SquarePause {
    
/// Square Pause icon path (combined)
...
/// Square Pause icon open subpaths
...
/// Square Pause icon closed subpaths
