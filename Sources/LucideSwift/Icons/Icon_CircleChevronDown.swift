...
internal enum LucideIcon_CircleChevronDown {
    
/// Circle Chevron Down icon path (combined)
...
/// Circle Chevron Down icon open subpaths
...
/// Circle Chevron Down icon closed subpaths
