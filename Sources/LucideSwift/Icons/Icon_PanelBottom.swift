...
/// Panel Bottom icon
internal enum LucideIcon_PanelBottom {
    
/// Panel Bottom icon path (combined)
...
/// Panel Bottom icon open subpaths
...
/// Panel Bottom icon closed subpaths
