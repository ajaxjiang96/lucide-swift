...
internal enum LucideIcon_SquareChevronRight {
    
/// Square Chevron Right icon path (combined)
...
/// Square Chevron Right icon open subpaths
...
/// Square Chevron Right icon closed subpaths
