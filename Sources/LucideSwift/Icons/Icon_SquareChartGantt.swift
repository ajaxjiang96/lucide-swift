...
internal enum LucideIcon_SquareChartGantt {
    
/// Square Chart Gantt icon path (combined)
...
/// Square Chart Gantt icon open subpaths
...
/// Square Chart Gantt icon closed subpaths
