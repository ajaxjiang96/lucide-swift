...
/// Square Kanban icon
internal enum LucideIcon_SquareKanban {
    
/// Square Kanban icon path (combined)
...
/// Square Kanban icon open subpaths
...
/// Square Kanban icon closed subpaths
