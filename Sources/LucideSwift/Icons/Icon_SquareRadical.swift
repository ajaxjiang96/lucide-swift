...
/// Square Radical icon
internal enum LucideIcon_SquareRadical {
    
/// Square Radical icon path (combined)
...
/// Square Radical icon open subpaths
...
/// Square Radical icon closed subpaths
