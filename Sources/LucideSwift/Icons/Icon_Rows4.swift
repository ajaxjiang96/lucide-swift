...
/// Rows 4 icon
internal enum LucideIcon_Rows4 {
    
/// Rows 4 icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 21.0, y: 7.5))
path.addLine(to: CGPoint(x: 3.0, y: 7.5))
path.move(to: CGPoint(x: 21.0, y: 12.0))
path.addLine(to: CGPoint(x: 3.0, y: 12.0))
path.move(to: CGPoint(x: 21.0, y: 16.5))
path.addLine(to: CGPoint(x: 3.0, y: 16.5))
