//
//  Icon_SquareArrowRightExit.swift
//  LucideSwift
//
...
internal enum LucideIcon_SquareArrowRightExit {
    
/// Square Arrow Right Exit icon path (combined)
...
path.move(to: CGPoint(x: 21.0, y: 6.344))
...
path.addLine(to: CGPoint(x: 21.0, y: 17.656))
    return path
}()
/// Square Arrow Right Exit icon open subpaths
...
/// Square Arrow Right Exit icon closed subpaths
