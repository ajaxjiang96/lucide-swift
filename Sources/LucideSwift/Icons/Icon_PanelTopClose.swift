...
internal enum LucideIcon_PanelTopClose {
    
/// Panel Top Close icon path (combined)
...
/// Panel Top Close icon open subpaths
...
/// Panel Top Close icon closed subpaths
