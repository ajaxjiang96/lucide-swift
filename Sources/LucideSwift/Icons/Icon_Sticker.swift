...
/// Sticker icon
internal enum LucideIcon_Sticker {
    
/// Sticker icon path (combined)
...
path.move(to: CGPoint(x: 8.01, y: 13.0))
path.addLine(to: CGPoint(x: 8.01, y: 13.0))
path.move(to: CGPoint(x: 16.0, y: 13.0))
path.move(to: CGPoint(x: 16.01, y: 13.0))
path.addLine(to: CGPoint(x: 16.01, y: 13.0))
path.move(to: CGPoint(x: 10.0, y: 16.0))
path.addCurve(to: CGPoint(x: 12.0, y: 17.0), control1: CGPoint(x: 10.0, y: 16.0), control2: CGPoint(x: 10.8, y: 17.0))
path.addCurve(to: CGPoint(x: 14.0, y: 16.0), control1: CGPoint(x: 13.3, y: 17.0), control2: CGPoint(x: 14.0, y: 16.0))
    return path
}()
/// Sticker icon open subpaths
