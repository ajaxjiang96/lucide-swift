...
/// Circle Minus icon
internal enum LucideIcon_CircleMinus {
    
/// Circle Minus icon path (combined)
...
/// Circle Minus icon open subpaths
...
/// Circle Minus icon closed subpaths
