...
/// Section icon
internal enum LucideIcon_Section {
    
/// Section icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 16.0, y: 5.0))
path.addCurve(to: CGPoint(x: 12.0, y: 2.0), control1: CGPoint(x: 16.0, y: 3.3431457505076194), control2: CGPoint(x: 14.209138999323175, y: 2.0))
path.addCurve(to: CGPoint(x: 8.0, y: 5.0), control1: CGPoint(x: 9.790861000676827, y: 2.0), control2: CGPoint(x: 8.0, y: 3.3431457505076194))
path.addCurve(to: CGPoint(x: 16.0, y: 12.0), control1: CGPoint(x: 8.0, y: 9.0), control2: CGPoint(x: 16.0, y: 8.0))
