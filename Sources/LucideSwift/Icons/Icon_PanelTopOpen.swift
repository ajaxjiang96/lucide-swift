...
/// Panel Top Open icon
internal enum LucideIcon_PanelTopOpen {
    
/// Panel Top Open icon path (combined)
...
/// Panel Top Open icon open subpaths
...
/// Panel Top Open icon closed subpaths
