...
internal enum LucideIcon_SquareArrowDown {
    
/// Square Arrow Down icon path (combined)
...
/// Square Arrow Down icon open subpaths
...
/// Square Arrow Down icon closed subpaths
