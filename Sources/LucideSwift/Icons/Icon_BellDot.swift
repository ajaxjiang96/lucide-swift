...
/// Bell Dot icon
internal enum LucideIcon_BellDot {
    
/// Bell Dot icon path (combined)
...
path.move(to: CGPoint(x: 11.68, y: 2.009))
path.addCurve(to: CGPoint(x: 6.0, y: 7.999999999999999), control1: CGPoint(x: 8.495355773010806, y: 2.1790897603996955), control2: CGPoint(x: 6.0002448180814065, y: 4.810816825713434))
...
path.addCurve(to: CGPoint(x: 18.529999999999998, y: 11.979), control1: CGPoint(x: 19.915999999999997, y: 14.477), control2: CGPoint(x: 19.061999999999998, y: 13.596))
