...
internal enum LucideIcon_PanelLeftDashed {
    
/// Panel Left Dashed icon path (combined)
...
/// Panel Left Dashed icon open subpaths
...
/// Panel Left Dashed icon closed subpaths
