...
/// Square Minus icon
internal enum LucideIcon_SquareMinus {
    
/// Square Minus icon path (combined)
...
/// Square Minus icon open subpaths
...
/// Square Minus icon closed subpaths
