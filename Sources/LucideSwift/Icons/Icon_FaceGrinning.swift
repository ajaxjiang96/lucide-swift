...
/// Face Grinning icon
internal enum LucideIcon_FaceGrinning {
    
/// Face Grinning icon path (combined)
...
/// Face Grinning icon open subpaths
...
/// Face Grinning icon closed subpaths
