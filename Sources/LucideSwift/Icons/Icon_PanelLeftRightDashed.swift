//
//  Icon_PanelLeftRightDashed.swift
//  LucideSwift
//
//  Auto-generated — DO NOT EDIT
//  Icon: panel-left-right-dashed
//

import SwiftUI

/// Panel Left Right Dashed icon
internal enum LucideIcon_PanelLeftRightDashed {
    
/// Panel Left Right Dashed icon path (combined)
...
/// Panel Left Right Dashed icon open subpaths
...
/// Panel Left Right Dashed icon closed subpaths
