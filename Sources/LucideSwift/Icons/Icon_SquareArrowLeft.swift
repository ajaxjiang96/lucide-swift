...
internal enum LucideIcon_SquareArrowLeft {
    
/// Square Arrow Left icon path (combined)
...
/// Square Arrow Left icon open subpaths
...
/// Square Arrow Left icon closed subpaths
