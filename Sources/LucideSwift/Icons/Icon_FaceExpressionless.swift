...
internal enum LucideIcon_FaceExpressionless {
    
/// Face Expressionless icon path (combined)
...
/// Face Expressionless icon open subpaths
...
/// Face Expressionless icon closed subpaths
