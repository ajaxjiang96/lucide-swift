...
/// Square Equal icon
internal enum LucideIcon_SquareEqual {
    
/// Square Equal icon path (combined)
...
/// Square Equal icon open subpaths
...
/// Square Equal icon closed subpaths
