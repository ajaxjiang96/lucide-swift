...
/// File Archive icon
internal enum LucideIcon_FileArchive {
    
/// File Archive icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 13.659, y: 22.0))
...
path.addLine(to: CGPoint(x: 4.0, y: 15.5))
...
/// File Archive icon open subpaths
...
/// File Archive icon closed subpaths
