...
path.addLine(to: CGPoint(x: 7.0, y: 16.5))
path.move(to: CGPoint(x: 17.0, y: 3.0))
path.addLine(to: CGPoint(x: 17.0, y: 21.0))
path.move(to: CGPoint(x: 17.0, y: 7.5))
path.addLine(to: CGPoint(x: 21.0, y: 7.5))
