...
internal enum LucideIcon_CircleArrowUp {
    
/// Circle Arrow Up icon path (combined)
...
/// Circle Arrow Up icon open subpaths
...
/// Circle Arrow Up icon closed subpaths
