//
//  Icon_PanelTopBottomDashed.swift
//  LucideSwift
//
...
internal enum LucideIcon_PanelTopBottomDashed {
    
/// Panel Top Bottom Dashed icon path (combined)
...
/// Panel Top Bottom Dashed icon open subpaths
...
/// Panel Top Bottom Dashed icon closed subpaths
