...
/// Square Check icon
internal enum LucideIcon_SquareCheck {
    
/// Square Check icon path (combined)
...
/// Square Check icon open subpaths
...
/// Square Check icon closed subpaths
