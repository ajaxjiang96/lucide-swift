...
internal enum LucideIcon_CircleArrowRight {
    
/// Circle Arrow Right icon path (combined)
...
/// Circle Arrow Right icon open subpaths
...
/// Circle Arrow Right icon closed subpaths
