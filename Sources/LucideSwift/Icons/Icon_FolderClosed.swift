...
/// Folder Closed icon
internal enum LucideIcon_FolderClosed {
    
/// Folder Closed icon path (combined)
...
/// Folder Closed icon open subpaths
...
/// Folder Closed icon closed subpaths
