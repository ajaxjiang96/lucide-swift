...
internal enum LucideIcon_TableCellsSplit {
    
/// Table Cells Split icon path (combined)
...
/// Table Cells Split icon open subpaths
...
/// Table Cells Split icon closed subpaths
