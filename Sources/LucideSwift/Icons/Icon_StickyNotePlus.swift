...
internal enum LucideIcon_StickyNotePlus {
    
/// Sticky Note Plus icon path (combined)
...
/// Sticky Note Plus icon open subpaths
...
/// Sticky Note Plus icon closed subpaths
