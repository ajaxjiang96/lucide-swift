...
/// Circle User icon
internal enum LucideIcon_CircleUser {
    
/// Circle User icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 7.0, y: 20.662))
...
path.addLine(to: CGPoint(x: 17.0, y: 20.662))
...
/// Circle User icon open subpaths
...
/// Circle User icon closed subpaths
