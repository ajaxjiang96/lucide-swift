...
/// Bookmark Plus icon
internal enum LucideIcon_BookmarkPlus {
    
/// Bookmark Plus icon path (combined)
...
/// Bookmark Plus icon open subpaths
...
/// Bookmark Plus icon closed subpaths
