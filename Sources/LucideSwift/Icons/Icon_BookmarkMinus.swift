...
/// Bookmark Minus icon
internal enum LucideIcon_BookmarkMinus {
    
/// Bookmark Minus icon path (combined)
...
/// Bookmark Minus icon open subpaths
...
/// Bookmark Minus icon closed subpaths
