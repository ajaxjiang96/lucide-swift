...
/// Circle Alert icon
internal enum LucideIcon_CircleAlert {
    
/// Circle Alert icon path (combined)
...
/// Circle Alert icon open subpaths
...
/// Circle Alert icon closed subpaths
