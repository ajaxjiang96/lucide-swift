...
/// Angry icon
internal enum LucideIcon_Angry {
    
/// Angry icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 16.0, y: 16.0))
path.addCurve(to: CGPoint(x: 12.0, y: 14.0), control1: CGPoint(x: 16.0, y: 16.0), control2: CGPoint(x: 14.5, y: 14.0))
path.addCurve(to: CGPoint(x: 8.0, y: 16.0), control1: CGPoint(x: 9.5, y: 14.0), control2: CGPoint(x: 8.0, y: 16.0))
path.move(to: CGPoint(x: 7.5, y: 8.0))
path.addLine(to: CGPoint(x: 10.0, y: 9.0))
path.move(to: CGPoint(x: 14.0, y: 9.0))
path.addLine(to: CGPoint(x: 16.5, y: 8.0))
